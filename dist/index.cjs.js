...
const ExternalNotificationScreen = ({ title, description, }) => {
    return (jsxRuntime.jsx(Container$1, { children: jsxRuntime.jsxs(MainContainer, { children: [jsxRuntime.jsx(TitleContainer, { children: jsxRuntime.jsx(TitleNotification, { children: title }) }), jsxRuntime.jsx(DescriptionContainer, { children: jsxRuntime.jsx(DescriptionNotification, { children: description }) })] }) }));
};
...
const InternalNotificationScreen = ({ barText, buttonLink, buttonText, code, discountRules, logo, notificationDescription, pageTitle, }) => {
    return (jsxRuntime.jsxs(Container, { children: [jsxRuntime.jsx(TopBar, { children: jsxRuntime.jsx(BarText, { children: barText ? barText : "Notificação" }) }), jsxRuntime.jsxs(ContentContainer, { children: [logo ? jsxRuntime.jsx(Logo, { src: logo, alt: "logo" }) : jsxRuntime.jsx("div", {}), jsxRuntime.jsx(LineFinal, {}), jsxRuntime.jsx(PageTitle, { children: pageTitle }), jsxRuntime.jsx(NotificationDescription, { children: notificationDescription }), buttonLink ? (jsxRuntime.jsx("a", { style: { textDecoration: "none" }, href: buttonLink, target: "_blank", rel: "noopener noreferrer", children: jsxRuntime.jsx(ButtonLink, { children: buttonText }) })) : (jsxRuntime.jsx("div", {})), code && jsxRuntime.jsx(LineFinal, {}), code ? (jsxRuntime.jsxs(ColumContainer, { children: [jsxRuntime.jsx(PageTitle, { children: "C\u00F3digo" }), jsxRuntime.jsx(CodeContainer, { children: jsxRuntime.jsx(CodeText, { children: code }) })] })) : (jsxRuntime.jsx("div", {})), discountRules ? (jsxRuntime.jsx(DiscountRules, { children: discountRules })) : (jsxRuntime.jsx("div", {}))] })] }));
};
